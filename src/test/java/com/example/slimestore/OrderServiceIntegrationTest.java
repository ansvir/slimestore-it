...
public class OrderServiceIntegrationTest {
    ...
    private static final String KAFKA_BROKER_PROPERTY = "spring.kafka.bootstrap-servers";
    ...
    static void kafkaProperties(DynamicPropertyRegistry registry) {
        registry.add(KAFKA_BROKER_PROPERTY, kafka::getBootstrapServers);
    }
    ...
    @Test
    @Description("given order when created then status created sent")
    ...
    @Test
    @Description("given order when deleted then status deleted sent")
